class PlayerRenderer {
  ...
  _colorHead(pr, pg, pb) {
    ...
    ctx.drawImage(this._headImg, 0, 0, headW, headH);
  ...
  render(index) {
    ...
    ctx.drawImage(
      this._head.canvas,
      hw - headW * this.scale * 0.5,
      defaultYOffset + hh - headH * this.scale * 0.5,
      headW * this.scale,
      headH * this.scale
    );
    ...
    ctx.drawImage(
      ...
      sw,
      sh,
      hw - swScaled * 0.5 - 2 * this.scale,
      defaultYOffset + hh - shScaled * 0.5 + 1 * this.scale,
      swScaled,
      shScaled
    );
